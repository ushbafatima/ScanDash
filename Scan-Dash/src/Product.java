...
// FreshProduce class (subclass of FreshGrocery)
class FreshProduce extends FreshGrocery {
    private String organicInfo;

    // Constructor
    public FreshProduce(String name, String prodID, double price, int quantity, double discount, String expiryDate, String manufactureDate, String  weight, String organicInfo) {
        super(name, prodID, price, quantity, discount, expiryDate, manufactureDate, weight);
        this.organicInfo = organicInfo;
    }
    ...
    // Getter and setter for organicInfo
    public String getOrganicInfo() {
        return organicInfo;
    }

    public void setOrganicInfo(String organicInfo) {
        this.organicInfo = organicInfo;
    }
...
// BakeryItems class (subclass of FreshGrocery)
class BakeryItems extends FreshGrocery {
    private String glutenInfo;

    // Constructor
    public BakeryItems(String name, String prodID, double price, int quantity, double discount, String expiryDate, String manufactureDate, String  weight, String glutenInfo) {
        super(name, prodID, price, quantity, discount, expiryDate, manufactureDate, weight);
        this.glutenInfo = glutenInfo;
    }
    ...
    // Getter and setter for glutenFree
    public String getGlutenInfo() {
        return glutenInfo;
    }

    public void setGlutenInfo(String glutenFree) {
        this.glutenInfo = glutenFree;
    }
