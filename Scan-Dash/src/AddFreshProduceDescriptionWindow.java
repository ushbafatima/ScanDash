...
public class AddFreshProduceDescriptionWindow extends JFrame implements AddDescriptionWindow {
	 ...
	 public static void main(String[] args) {
           ...
           UIManager.setLookAndFeel( new FlatDarkLaf() );
	        ...
	        EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                try {
	                	AddFreshProduceDescriptionWindow frame = new AddFreshProduceDescriptionWindow(null);
	 ...
	 * Create the frame.
	 */
	public AddFreshProduceDescriptionWindow(FreshProduce freshProduceItem) {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int response = JOptionPane.showConfirmDialog(AddFreshProduceDescriptionWindow.this,
		...
		addDescriptionbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (ProductManagement.addProductToCategoryDB(freshProduceItem)) {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Organic", "Inorganic"}));
		comboBox.setBounds(176, 160, 96, 21);
		contentPane.add(comboBox);
		
		weightBox = new JComboBox();
		weightBox.setModel(new DefaultComboBoxModel(new String[] {"g", "kg", "lb"}));
		weightBox.setBounds(282, 130, 52, 21);
	...
	public void setDescription(FreshProduce product) {
	    ...
	    if (expiryDate != null && manufactureDate != null) {
	        ...
	        product.setOrganicInfo((String)comboBox.getSelectedItem());
	    }
	}
